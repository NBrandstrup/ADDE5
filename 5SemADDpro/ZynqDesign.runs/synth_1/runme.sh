...
HD_PWD='C:/Users/nbnb2/OneDrive/5SemADDpro/ZynqDesign.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Z_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Z_system_wrapper.tcl
