...
HD_PWD='C:/Users/nbnb2/OneDrive/5SemADDpro/ZynqDesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Z_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Z_system_wrapper.tcl -notrace
